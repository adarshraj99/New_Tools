1. Elements are : Tosca commander ,Tosca XSCan ,
2. Elements can be added by Basic view > select elements on the web app.  Or, Adv view > select elements on the Tosca app.
